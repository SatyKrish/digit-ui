...
import { Maximize2, Minimize2, Pin, PinOff, SidebarClose, SidebarOpen } from "lucide-react"
import type { Artifact, ArtifactPanelProps } from "@/types/artifacts"

export function ArtifactPanel({ artifacts, isChatMinimized = false, onToggleChatMinimized }: ArtifactPanelProps) {
